		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Layout ",
									"targetURL": "#zprojectteste1205-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zprojectteste1205-display": {
								"semanticObject": "zprojectteste1205",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zprojectteste1205",
									"url": sap.ui.require.toUrl("zprojectteste1205")
								}
							}
						}
					}
