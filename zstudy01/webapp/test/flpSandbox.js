					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "First study prac",
									"targetURL": "#zstudy01-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zstudy01-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zstudy01",
									"url": sap.ui.require.toUrl("zstudy01")
								}
							}
						}
					}
