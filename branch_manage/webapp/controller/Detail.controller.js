sap.ui.define(
    ...
    "sap/tnt/NavigationList","sap/tnt/NavigationListItem"],
    /**
     * @param {typeof sap.ui.core.mvc.Controller} Controller
     */
    function (Controller,JSONModel,Filter,NavigationList,NavigationListItem) {
      "use strict";
  
      return Controller.extend("branchmanage.controller.Detail", {
        formatter: {
        ...
        InsBtnPress : function(oEvent){
          ...
          this.loadFragment({
            name: "branchmanage.view.fragments.Inspection",
        ...
        RepBtnPress : function(oEvent){
          ...
          if (oDialog) {
            var oFilter = new Filter('Carid', sap.ui.model.FilterOperator.EQ, oSelectedRow.Carid);
            aFilters.push(oFilter);
            this.openRepDialogWithFilters(oDialog, oRepTable, aFilters);
            return;
          }
          
          this.loadFragment({
            name: "branchmanage.view.fragments.repair",
          }).then(function(oDialog) {
            var oFilter = new Filter('Carid', sap.ui.model.FilterOperator.EQ, oSelectedRow.Carid);
            aFilters.push(oFilter);
            that.openRepDialogWithFilters(oDialog, oRepTable, aFilters);
          }, this);
          
        },
        RetBtnPress : function(oEvent){
          var that = this;          
          var oDialog = this.byId("rental");
          var aFilters = [];
          ...
          if (oDialog) {
            var oFilter = new Filter('Carid', sap.ui.model.FilterOperator.EQ, oSelectedRow.Carid);
            aFilters.push(oFilter);
            this.openRepDialogWithFilters(oDialog, oRenTable, aFilters);
            return;
          }
          
          this.loadFragment({
            name: "branchmanage.view.fragments.Rental",
          }).then(function(oDialog) {
            var oFilter = new Filter('Carid', sap.ui.model.FilterOperator.EQ, oSelectedRow.Carid);
            aFilters.push(oFilter);
            that.openRepDialogWithFilters(oDialog, oRenTable, aFilters);
          }, this);
