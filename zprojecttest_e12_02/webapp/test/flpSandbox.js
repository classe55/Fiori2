		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#C05zprojectteste1202-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"C05zprojectteste1202-display": {
								"semanticObject": "C05zprojectteste1202",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=C05.zprojectteste1202",
									"url": sap.ui.require.toUrl("C05/zprojectteste1202")
								}
							}
						}
					}
