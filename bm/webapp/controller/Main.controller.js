sap.ui.define([
    ...
    , "sap/ui/core/Fragment","bm/model/fragment"
],
    /**
     * @param {typeof sap.ui.core.mvc.Controller} Controller
     */
    function (Controller,JSONModel,Sorter,Filter,Fragment,fragment) {
        "use strict";

        return Controller.extend("bm.controller.Main", {
            formatter: {
              ...
              onInit: function () {
                ...
                this.byId('map').setHeight('700px');
                this.byId('map').setWidth('800px');
                // 기존
                // var ozModel = new JSONModel();
              ...
              onFirstPress: function (oEvent) {
                ...
                // this.loadFragment({
                //   name: "bm.view.fragments.WholeCar",                 
                //   controller : this
              ...
              onTilePress : function(oEvent){
                ...
                //   return;
                // }
                // // var sDynamicId = "WholeCar_" + new Date().getTime(); // 동적인 ID 생성
                // this.loadFragment({
                //   // id : sDynamicId,
                //   name: "bm.view.fragments.WholeCar",
                // }).then(function(oDialog) {
                ...
                var that = this;
                this.oDialog.then(function(oDialog) {
                  // var oTable = sap.ui.core.Fragment.byId("bm.view.fragments.WholeCar", "wholeCarTable");
                  var oTable = that.byId("wholeCarTable");
                  var oFilter = new Filter('Castatus', sap.ui.model.FilterOperator.EQ, sCondition);                  
                  aFilters.push(oFilter);
