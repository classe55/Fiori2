			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ERzfercarin-display": {
								"semanticObject": "ERzfercarin",
								"action": "display",
								"description": "수리 차량 입고",
								"title": "수리 차량 입고",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ER.zfercarin",
									"url": sap.ui.require.toUrl("ER/zfercarin")
								}
							}
						}
					}
