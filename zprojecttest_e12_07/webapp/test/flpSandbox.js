		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Router",
									"targetURL": "#zprojectteste1207-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zprojectteste1207-display": {
								"semanticObject": "zprojectteste1207",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zprojectteste1207",
									"url": sap.ui.require.toUrl("zprojectteste1207")
								}
							}
						}
					}
