		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Northwind",
									"targetURL": "#ntzprojectodatae1203-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ntzprojectodatae1203-display": {
								"semanticObject": "ntzprojectodatae1203",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nt.zprojectodatae1203",
									"url": sap.ui.require.toUrl("nt/zprojectodatae1203")
								}
							}
						}
					}
