		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Dynamic Page",
									"targetURL": "#zprojectteste1206-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zprojectteste1206-display": {
								"semanticObject": "zprojectteste1206",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zprojectteste1206",
									"url": sap.ui.require.toUrl("zprojectteste1206")
								}
							}
						}
					}
