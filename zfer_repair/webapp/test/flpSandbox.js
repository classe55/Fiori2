		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "수리 요청",
									"targetURL": "#ERzferrepair-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ERzferrepair-display": {
								"semanticObject": "ERzferrepair",
								"action": "display",
								"description": "수리 요청",
								"title": "수리 요청",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ER.zferrepair",
									"url": sap.ui.require.toUrl("ER/zferrepair")
								}
							}
						}
					}
