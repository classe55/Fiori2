		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "지점별 보유차량 관리",
									"targetURL": "#ERzferbranchmanage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ERzferbranchmanage-display": {
								"semanticObject": "ERzferbranchmanage",
								"action": "display",
								"description": "지점별 보유차량 관리",
								"title": "지점별 보유차량 관리",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ER.zferbranchmanage",
									"url": sap.ui.require.toUrl("ER/zferbranchmanage")
								}
							}
						}
					}
